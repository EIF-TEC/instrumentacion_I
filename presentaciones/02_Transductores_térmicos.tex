...
\begin{frame}{Estándar de tolerancias RTD}
 \begin{itemize}
     ...
     \item \textbf{Clase A}
     \begin{itemize}
         \item Tolerancia de Temperatura: $\pm (0.15 + .002|T| \si{\celsius})$
     \end{itemize}
      \item \textbf{Clase B}
     \begin{itemize}
         \item Tolerancia de Temperatura: $\pm (0.30 + .005|T| \si{\celsius})$
         \end{itemize}
    \item \textbf{Clase C}
     \begin{itemize}
         \item Tolerancia de Temperatura: $\pm (1.2 + .005|T| \si{\celsius})$
     \end{itemize}
 \end{itemize}
\end{frame}
...
\begin{frame}{Termistores}
    \begin{columns}[c, onlytextwidth]
        \begin{column}{0.55\textwidth}
            \begin{itemize}
                \item Se les denomina \textit{Sensor on a chip} por su tamaño reducido y facilidad para encapsular en vidrio o epoxi.
