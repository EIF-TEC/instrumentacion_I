...
\begin{frame}{Definiciones}
    \begin{columns}[c, onlytextwidth]
        ...
        \begin{column}{0.50\textwidth}
            \includegraphics[width = 1\linewidth]{Nivel/Introducción.jpg}
...
\begin{frame}{Tipos de Medición}
    \begin{columns}[c, onlytextwidth]
        \begin{column}{0.45\textwidth}
        \includegraphics[width = 1\linewidth]{Nivel/Nivel-de-liquidos.png}
        \tiny{Tomado de \cite{sole2005instrumentacion}}
        \end{column}
        \begin{column}{0.50\textwidth}
            \includegraphics[width = 1\linewidth]{Nivel/Nivel-de-solidos.png}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Tecnologías de Medición}
 ...
 \begin{columns}[c, onlytextwidth]
        ...
        \centering
            \includegraphics[width=6.5cm]{Nivel/level-sensors.jpg}
...
\begin{frame}{Instrumentos de medición directa}
    \begin{columns}[c, onlytextwidth]
        ...
        \end{column}
        \begin{column}{0.50\textwidth}
            \includegraphics[width = 1.1\linewidth]{Nivel/MedicionSonda.png}
            \tiny{Tomado de \cite{sole2005instrumentacion}}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Instrumentos de medición directa}
    \begin{columns}[c, onlytextwidth]
        \begin{column}{0.45\textwidth}
        \includegraphics[width = 1\linewidth]{Nivel/medidor_cristal.png}
            %\tiny{Tomado de \cite{sole2005instrumentacion}}
        \end{column}
        \begin{column}{0.50\textwidth}
...
\begin{frame}{Instrumentos de medición directa}
    \begin{columns}[c, onlytextwidth]
        ...
        \end{column}
        \begin{column}{0.50\textwidth}
            \includegraphics[width = 1.1\linewidth]{Nivel/flotador.png}
            \tiny{Tomado de \cite{sole2005instrumentacion}}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Instrumentos de medición directa}
    \begin{columns}[c, onlytextwidth]
        \begin{column}{0.45\textwidth}
        \centering
        \includegraphics[width = 0.6\linewidth]{Nivel/Servooperado.jpg}
...
\begin{frame}{Instrumentos de medición directa}
    \begin{columns}[c, onlytextwidth]
        ...
        \end{column}
        \begin{column}{0.50\textwidth}
            \includegraphics[width = 1.1\linewidth]{Nivel/Magnetostrictivo.jpg}
...
\begin{frame}{Instrumentos basados en presión hidrostática}
    \begin{columns}[c, onlytextwidth]
        ...
        \end{column}
        \begin{column}{0.50\textwidth}
            \includegraphics[width = 1.1\linewidth]{Nivel/Manometrico.jpg}
            \tiny{Tomado de \cite{sole2005instrumentacion}}
...
\begin{frame}{Instrumentos basados en presión hidrostática}
    \begin{columns}[c, onlytextwidth]
        \begin{column}{0.45\textwidth}
        \centering
        \includegraphics[width = 1\linewidth]{Nivel/Burbujeo.png}
...
\begin{frame}{Instrumentos basados en presión hidrostática}
    \begin{columns}[c, onlytextwidth]
        ...
        \end{column}
        \begin{column}{0.50\textwidth}
            \includegraphics[width = 1.1\linewidth]{Nivel/Presión diferencial.jpg}           \tiny{\href{https://www.emerson.com/es-es/automation/measurement-instrumentation/pressure-measurement/about-differential-pressure-dp-level-measurement}{By: Emerson}}
...
\begin{frame}{Instrumentos basados en presión hidrostática}
    ...
    \centering
    \includegraphics[width = 0.8\linewidth]{Nivel/Interfaz.PNG}\\
            \tiny{Tomado de \cite{sole2005instrumentacion}}
\end{frame}
...
\begin{frame}{Instrumentos basados en desplazamiento}
    \begin{columns}[c, onlytextwidth]
        \begin{column}{0.45\textwidth}
        \centering
        \includegraphics[width = 0.8\linewidth]{Nivel/Desplazamiento.jpg}\\
...
\begin{frame}{Instrumentos basados en características eléctricas}
    \begin{columns}[c, onlytextwidth]
        ...
        \begin{column}{0.50\textwidth}
        \centering
            \includegraphics[width = 1.1\linewidth]{Nivel/Resistivo.jpg}           \tiny{\href{http://www.divatecsl.com/productos/interruptor-nivel-conductivo-cfp/}{By: Divatec}}
...
\begin{frame}{Instrumentos basados en características eléctricas}
    \begin{columns}[c, onlytextwidth]
        \begin{column}{0.5\textwidth}
                \centering
            \includegraphics[width = 0.9\linewidth]{Nivel/capacitance.png}\\           \tiny{\href{https://www.semanticscholar.org/paper/A-Review-on-Capacitive-Type-Sensor-for-Measurement-Kumar-Rajita/2e3d6ede8338e72be9972741eafed7f50388b53a}{A Review on Capacitive-Type Sensor for Measurement of Height of Liquid Level}}
        \end{column}
        \begin{column}{0.50\textwidth}
...
\begin{frame}{Constantes dieléctricas de varios tipos de materiales}
    \begin{columns}[c, onlytextwidth]
        ...
        \begin{column}{0.50\textwidth}
        \centering
            \includegraphics[width = 0.9\linewidth]{Nivel/capacitance_types.png} \\          \tiny{\href{https://www.toshbrocontrols.com/level-transmitter/rf-capacitance-level-transmitter}{By: Toshbrocontrols}}
...
\begin{frame}{Medidores de nivel por ultrasonido}
    \begin{columns}[c, onlytextwidth]
        ...
        \begin{column}{0.50\textwidth}
        \centering
            \includegraphics[width = 0.8\linewidth]{Nivel/ultrasonic.jpg}\\
...
\begin{frame}{Medidores de radar o microondas}
    \begin{columns}[c, onlytextwidth]
        \begin{column}{0.5\textwidth}
                \centering
            \includegraphics[width = 0.9\linewidth]{Nivel/radar}\\           \tiny{\href{http://www.edcontrol.com/index.php/instrumentacion/item/12-confusion-en-el-mundo-de-las-mediciones-de-nivel-por-radar-no-es-para-tanto}{Técnicas de radar}}
        \end{column}
        \begin{column}{0.50\textwidth}
...
\begin{frame}{Medidores de nivel por radiación}
    \begin{columns}[c, onlytextwidth]
        ...
        \begin{column}{0.50\textwidth}
        \centering
            \includegraphics[width = 0.8\linewidth]{Nivel/radiación.png}\\
            \tiny{Tomado de \cite{sole2005instrumentacion}}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Medidores de nivel láser}
    \begin{columns}[c, onlytextwidth]
        \begin{column}{0.5\textwidth}
                \centering
            \includegraphics[width = 0.9\linewidth]{Nivel/lasersensor.jpg}\\           \tiny{\href{https://www.mouser.com/new/stmicroelectronics/stm-vl53lox-sensor/}{STMicroelectronics VL53L0X Time-of-Flight Ranging Sensor}}
        \end{column}
        \begin{column}{0.50\textwidth}
...
\begin{frame}{Medidores de nivel de sólidos (punto fijo)}
    \begin{columns}[c, onlytextwidth]
        ...
        \begin{column}{0.50\textwidth}
        \centering
            \includegraphics[width = 0.8\linewidth]{Nivel/solido_diafragma.jpg}\\
...
\begin{frame}{Medidores de nivel de sólidos (punto fijo)}
    \begin{columns}[c, onlytextwidth]
        \begin{column}{0.5\textwidth}
                \centering
            \includegraphics[width = 0.9\linewidth]{Nivel/vibracion.png}\\ \tiny{\href{https://www.secoin.com.uy/productos/}{By: Secoin}}
        \end{column}
...
\begin{frame}{Medidores de nivel de sólidos (punto fijo)}
    \begin{columns}[c, onlytextwidth]
        ...
        \begin{column}{0.50\textwidth}
        \centering
            \includegraphics[width = 0.9\linewidth]{Nivel/PaletaRotativa.jpg}\\
