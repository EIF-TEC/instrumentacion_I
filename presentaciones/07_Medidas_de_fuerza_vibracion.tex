...
\begin{frame}{¿Como medir fuerza?}
    \begin{columns}[c, onlytextwidth]
        ...
        \begin{column}{0.45\textwidth}
            \centering
            \includegraphics[width = 0.8\linewidth]{Fuerza_Vibracion/fuerza1.JPG}
            \includegraphics[width = 0.8\linewidth]{Fuerza_Vibracion/fuerza2.JPG}
            \vspace{0.5cm}
...
\begin{frame}{Galgas extensométricas}
    \begin{columns}[c, onlytextwidth]
        ...
        \begin{column}{0.40\textwidth}
            \includegraphics[width = 1\linewidth]{Fuerza_Vibracion/straingauge.jpg}
