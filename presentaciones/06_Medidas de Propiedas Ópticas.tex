...
\begin{frame}{Luz}
        ...
        \begin{column}{0.45\textwidth}
            \centering
            \includegraphics[width = 0.9\linewidth]{../figures/Optica/Luz.jpg}
...
\begin{columns}[c, onlytextwidth]
        ...
        \begin{column}{0.45\textwidth}
            \centering
            \includegraphics[width = 0.8\linewidth]{../figures/Optica/UsosRefracccion_Radiacion.PNG}
...
\begin{columns}[c, onlytextwidth]
        \begin{column}{0.45\textwidth}
            \centering
            \includegraphics[width = 1\linewidth]{../figures/Optica/onda-partícula.png}\\
...
\begin{columns}[c, onlytextwidth]
        \begin{column}{0.4\textwidth}
            \centering
            \includegraphics[width = 0.48\linewidth]{../figures/Optica/Espectro.png}\\
        \end{column}
...
\begin{frame}{Espectro Electromagnético y Óptico}
            \centering
            \includegraphics[width = 0.8\linewidth]{../figures/Optica/1200px-EM_Spectrum_Properties_es.svg.png}\\
...
\begin{frame}{Espectro Óptico}
            ...
            \includegraphics[width = 1\linewidth]{../figures/Optica/Espectro Visible.png}\\
...
\begin{frame}{Conceptos Básicos de las ondas}
    \begin{columns}[c, onlytextwidth]
        ...
        \begin{column}{0.45\textwidth}
            \centering
            \includegraphics[width = 0.8\linewidth]{../figures/Optica/ondas.jpg}\\
...
\begin{frame}{Conceptos Básicos de las ondas}
    \begin{columns}[c, onlytextwidth]
        ...
        \begin{column}{0.45\textwidth}
            \centering
            \centering
            \includegraphics[width = 1\linewidth]{../figures/Optica/amplitud.jpg}
            \vspace{0.5cm}
...
\begin{frame}{Refracción, reflexión, atenuación y dispersión}
    \begin{columns}[c, onlytextwidth]
        ...
        \begin{column}{0.45\textwidth}
            \centering
            \includegraphics[width = 0.9\linewidth]{../figures/Optica/Radiometry.PNG}
...
\begin{frame}{Refracción}
    \begin{columns}[c, onlytextwidth]
        ...
        \begin{column}{0.45\textwidth}
            \centering
            \includegraphics[width = 0.9\linewidth]{../figures/Optica/lense.PNG}
...
\begin{frame}{Reflexión}
    ...
    \begin{column}{0.45\textwidth}
            \centering
            \includegraphics[width = 0.9\linewidth]{../figures/Optica/reflection.PNG}
            \tiny{Tomado de \cite{Fraden_2016}}
...
\begin{frame}{Reflexión}
            \centering
            \includegraphics[width = 0.7\linewidth]{../figures/Optica/Reflectance_materials.PNG}\\
            \tiny{Tomado de \cite{Fraden_2016}}
...
\begin{frame}{Atenuación}
    \begin{columns}[c, onlytextwidth]
        ...
        \begin{column}{0.45\textwidth}
            \centering
            \includegraphics[width = 0.9\linewidth]{../figures/Optica/atenuacion.png}
...
\begin{frame}{Dispersión}
    ...
    \begin{column}{0.45\textwidth}
            \centering
            \includegraphics[width = 0.7\linewidth]{../figures/Optica/Prisms_with_high_and_low_dispersion.png}\\
...
\begin{frame}{Refracción, reflexión, atenuación y dispersión}
            \centering
            \includegraphics[width = 6cm]{../figures/Optica/microscopio_optico.png}\\
...
\begin{frame}{Absorción, fotoconductividad y efecto fotoeléctrico}
    \begin{columns}[c, onlytextwidth]
        ...
        \begin{column}{0.40\textwidth}
            \centering
            \includegraphics[width = 0.9\linewidth]{../figures/Optica/barrido electronico.jpg}\\
...
\begin{frame}{Absorción, fotoconductividad y efecto fotoeléctrico}
    \centering
    \includegraphics[width=5.5cm]{../figures/Optica/Silicon.png}
\end{frame}
...
\begin{frame}{Absorción}
    \begin{columns}[c, onlytextwidth]
        ...
        \begin{column}{0.45\textwidth}
            \centering
    \includegraphics[width = 1\linewidth]{../figures/Optica/Absorción.png}\\
            \tiny{Tomado de \cite{Fraden_2016}}
...
\begin{frame}{Fotoconductividad}
    \begin{columns}[c, onlytextwidth]
        ...
        \begin{column}{0.45\textwidth}
            \centering
    \includegraphics[width = 1\linewidth]{../figures/Optica/photocondutivity.jpg}\\
...
\begin{frame}{Efecto fotoeléctrico}
    \begin{columns}[c, onlytextwidth]
        ...
        \begin{column}{0.45\textwidth}
            \centering
    \includegraphics[width = 1\linewidth]{../figures/Optica/Fotoefecto.png}\\
            \tiny{Tomado de \cite{Fraden_2016}}
...
\begin{frame}{Dispositivos opto electrónicos y sensores}
    \begin{columns}[onlytextwidth]
        ...
        \begin{column}{0.45\textwidth}
            \centering
            \includegraphics[width = 1\linewidth]{../figures/Optica/Light_sensor.png}
            \tiny{Tomado de \cite{Fraden_2016}}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Fotodiodos}
    \begin{columns}[onlytextwidth]
        ...
        \begin{column}{0.45\textwidth}
            \centering
            \includegraphics[width = 1\linewidth]{../figures/Optica/fotodiodos.PNG}
            \tiny{Tomado de \cite{Fraden_2016}}
...
\begin{frame}{Fototransistor}
    \begin{columns}[onlytextwidth]
        ...
        \begin{column}{0.45\textwidth}
            \centering
            \includegraphics[width = 0.9\linewidth]{../figures/Optica/fototransistor.PNG}
            \tiny{Tomado de \cite{Fraden_2016}}
...
\begin{frame}{Fotoresistor}
    \begin{columns}[onlytextwidth]
        ...
        \begin{column}{0.45\textwidth}
            \centering
            \includegraphics[width = 1\linewidth]{../figures/Optica/fotoresistores.PNG}
            \tiny{Tomado de \cite{Fraden_2016}}
            \tiny{Conexión de un fotodiodo a) circuito equivalente, b)circuito de carga}
        \end{column}
    \end{columns}
...
\begin{frame}{Transmisión, fuentes y detectores de luz}
    \begin{columns}[c, onlytextwidth]
        ...
        \end{column}
        \begin{column}{0.40\textwidth}
            \includegraphics[width = 1\linewidth]{../figures/Optica/barrera.jpg}
...
\begin{frame}{Microscopio de barrido electrónico}
    ...
    \begin{column}{0.45\textwidth}
            \centering
            \includegraphics[width = 0.7\linewidth]{../figures/Optica/microscopio.jpg}\\
...
\begin{frame}{Microscopio de barrido electrónico}
    \centering
    \includegraphics[width=8cm]{../figures/Optica/Microscopia.jpg}
